...
namespace EventBusRabbitMQ.Producer
{
    public class EventBusRabbitMQProducer
    {
        ...
        public EventBusRabbitMQProducer(IRabbitMQPersistentConnection persistConnection, ILogger<EventBusRabbitMQProducer> logger, int retryCount)
        {
            _persistentConnection = persistConnection;
            _logger = logger;
